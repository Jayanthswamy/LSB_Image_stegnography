...
{
    /* Source Image info */
    char *src_image_fname;   //source file 
    FILE *fptr_src_image;    // source file pointer
    uint image_capacity;     // capacity of the source file
    uint bits_per_pixel;
    char image_data[MAX_IMAGE_BUF_SIZE];   
	char magic_string[10];     // Declaring the magic string 
	int magic_string_len;    //magic string length
